(function() {
    ...
    var autoUpdate = false,
      ...
      var cdSlider = document.querySelector('.cd-slider-5'),
          item = cdSlider.querySelectorAll("li"),
          nav = cdSlider.querySelector("nav");
  
      item[0].className = "current_slide_5";
      ...
      var ua = window.navigator.userAgent;
          ...
          if ( msie > 0 ) {
              ...
              if (version === 9) { cdSlider.className = "cd-slider-5 ie9";}
      }
      ...
      function prevSlide() {
          var currentSlide = cdSlider.querySelector("li.current_slide_5"),
          ...
          prevSlide.className = "current_slide_5";
      ...
      function nextSlide() {
          ...
          currentSlide.className = "";
          nextSlide.className = "current_slide_5";
